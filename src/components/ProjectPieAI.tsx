      ...
      <div className="flex flex-wrap-reverse justify-center sm:gap-20">
        ...
        <div className="z-30 mb-7 flex w-3/4 min-w-[250px] flex-col justify-center gap-4 font-almamonoLight text-2xl text-white sm:text-4xl md:w-1/4">
          ...
          <p className="max-w-full text-justify text-sm sm:text-lg">
            Me and my colleague built an artificial neural network that can diagnose pneumonia with above 90% accuracy.
            I was invited to present this project at an AI event hosted by{" "}
            <a className="cursor-pointer font-bold underline" href="https://deeplearning.ai">
              Deeplearning.ai
            </a>{" "}
            called Pie & AI. The research paper for this project is currently under review for publication.
          </p>
          <div
            onClick={() => {
